        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <div class=" text-center">
                <a href="dashboard.html"> <button type="button" class="btn btn-success" >Annulla</button></a>
                <a href="dashboard.html"> <button type="button" class="btn btn-success"> Aggiungi</button></a>
            </div>
